...
export function ScoreBoard({ players, submitScore, deletePlayer, resetGame }: ScoreBoardProps) {
  const [points, setPoints] = useState<string[]>(() => Array(players.length).fill(''))
          ...
          <AlertDialogContent className="bg-zinc-900 border-zinc-800">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="text-zinc-400">
                Esta acción no se puede deshacer. Se borrarán todos los puntajes y jugadores de la partida actual.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
